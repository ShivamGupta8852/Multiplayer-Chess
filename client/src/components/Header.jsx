...
const Header = () => {
  ...
  return (
    <nav className='flex justify-between items-center px-6 py-[10px] w-full h-16 bg-slate-950 text-white'>
        ...
        <button onClick={handletoggle} className='md:hidden text-2xl cursor-pointer text-green-300'>
          {
